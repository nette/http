...
class RequestFactoryPortTest extends Tester\TestCase
{
    ...
    public function providerCreateHttpRequestWithTrustedProxy(): array
    {
        return [
            ...
            [443, ['HTTP_X_FORWARDED_PORT' => '443', 'HTTP_FORWARDED' => 'for=192.168.1.1;host=example.com;proto=https']],
            [44443, ['HTTP_X_FORWARDED_PORT' => '8080', 'HTTP_FORWARDED' => 'for=192.168.1.1;host=example.com:44443;proto=https']],
        ];
    }
}
