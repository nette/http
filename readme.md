...
getFiles(): array
-----------------
Returns an array of all uploads. It can also be a multidimensional array whose leaves are always objects [Nette\Http\FileUpload](https://api.nette.org/3.0/Nette/Http/FileUpload.html):
